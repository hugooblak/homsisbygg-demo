<?php
/**
 * Homsis Bygg AB theme functions.
 *
 * Kept short on purpose. Design lives in theme.json, markup in templates and patterns.
 * Lead capture lives in the "Homsis Bygg AB Leads" plugin, so leads survive a theme change.
 *
...
add_action(
	'wp_enqueue_scripts',
	function () {
		wp_enqueue_style( 'homsisbygg', get_stylesheet_uri(), array(), wp_get_theme()->get( 'Version' ) );
	}
);
add_action(
	'after_setup_theme',
...
add_action(
	'init',
	function () {
		register_block_style( 'core/paragraph', array( 'name' => 'eyebrow', 'label' => __( 'Eyebrow label', 'homsisbygg' ) ) );
		register_block_style( 'core/list', array( 'name' => 'checklist', 'label' => __( 'Tick list', 'homsisbygg' ) ) );

		register_block_pattern_category( 'homsisbygg-sections', array( 'label' => __( 'Homsis Bygg AB sections', 'homsisbygg' ) ) );
		register_block_pattern_category( 'homsisbygg-pages', array( 'label' => __( 'Homsis Bygg AB page layouts', 'homsisbygg' ) ) );
	}
);
