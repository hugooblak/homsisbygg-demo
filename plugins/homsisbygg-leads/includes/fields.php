...
function npl_choices() {
	return apply_filters(
		...
		array(
			'service'  => array(
				'replacement' => __( 'Lägga om hela taket', 'homsisbygg-leads' ),
				'storm'       => __( 'Storm or hail damage', 'homsisbygg-leads' ),
				'repair'      => __( 'Läcka eller reparation', 'homsisbygg-leads' ),
				'inspection'  => __( 'Bara en besiktning', 'homsisbygg-leads' ),
				'not-sure'    => __( 'Vet inte än', 'homsisbygg-leads' ),
			),
			'timeline' => array(
				'asap'     => __( 'Så snart som möjligt', 'homsisbygg-leads' ),
				'1-3'      => __( 'Inom 1–3 månader', 'homsisbygg-leads' ),
				'research' => __( 'Jag kollar bara priser', 'homsisbygg-leads' ),
			),
		)
	);
}
...
function npl_consent_text() {
	return apply_filters(
		'npl_consent_text',
		__( 'Genom att skicka förfrågan godkänner du att vi kontaktar dig om ditt tak. Vi sparar uppgifterna bara för det, lämnar dem aldrig vidare, och du kan när som helst be oss radera dem.', 'homsisbygg-leads' )
	);
}
...
function npl_statuses() {
	return array(
		'new'       => __( 'New', 'homsisbygg-leads' ),
		'contacted' => __( 'Kontaktad', 'homsisbygg-leads' ),
		'quoted'    => __( 'Quote sent', 'homsisbygg-leads' ),
		'won'       => __( 'Won', 'homsisbygg-leads' ),
		'lost'      => __( 'Lost', 'homsisbygg-leads' ),
		'spam'      => __( 'Misstänkt spam', 'homsisbygg-leads' ),
	);
}
